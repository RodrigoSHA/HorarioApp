        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                if (id == R.id.nav_pag_principal) {
                    ...
                    Toast.makeText(CalendarioActivity.this, "Ya estás en Calendario", Toast.LENGTH_SHORT).show();

                } else if (id == R.id.nav_courses) {
                    Toast.makeText(CalendarioActivity.this, "Ingresar Cursos", Toast.LENGTH_SHORT).show();

                } else if (id == R.id.nav_config) {
                    Toast.makeText(CalendarioActivity.this, "Abrir Configuración", Toast.LENGTH_SHORT).show();
